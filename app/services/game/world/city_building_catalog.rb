    ...
    class CityBuildingCatalog
      BUILDINGS = {
        ...
        "guard_tower" => {
          "title" => "Башня Дозора",
          "kind" => "guard",
          "summary" => "Живые переходы в соседние кварталы с текущей площади."
        },
        "city_hall" => {
          "title" => "Ратуша Угля",
          "kind" => "landmark",
        ...
        "post" => {
          ...
          "kind" => "post",
          "summary" => "Личная записка персонажа. Межгородская почта — позже."
        },
        "magic_school" => {
          "title" => "Школа Завесы",
          "kind" => "landmark",
        ...
        "dealer_house" => {
          "title" => "Дом Скупщика",
          "kind" => "landmark",
          "summary" => "Скупка трофеев. Рабочий прилавок — Скупщик Пепла на Рынке."
        },
        "souvenir_shop" => {
        ...
        "bank" => {
          "title" => "Банк Смолы",
          "kind" => "bank",
          "summary" => "Хранение NV вне кармана: вклад и снятие в сейфе персонажа."
        },
        "temple" => {
        ...
        "law_abode" => {
          ...
          "kind" => "law",
          "summary" => "Объявление и смена склонности персонажа."
        },
        "prison" => {
