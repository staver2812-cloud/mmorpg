  ...
  module World
    ...
    class StartPlayerAssault
      ...
      def validate!(defender)
        ...
        raise AssaultViolationError, I18n.t("game.flashes.fight_still_active") if active_match_for?(attacker)
        raise AssaultViolationError, I18n.t("game.world.assault_target_fighting") if active_match_for?(defender)
        raise AssaultViolationError, I18n.t("game.world.assault_not_nearby") unless co_located?(defender)
        raise AssaultViolationError, I18n.t("game.world.assault_safe_zone") if safe_zone?(attacker) || safe_zone?(defender)
      ...
      def active_match_for?(character)
