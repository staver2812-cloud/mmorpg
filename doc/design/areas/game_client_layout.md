...
auth/public login, Shop status-row recoveries, Quests cards, Inventory, and
Manage also compress under ≤360px / coarse pointers. Expanded RESPONSIVE audit
for the recorded acceptance sample at 320 CSS px / those inputs (plus 200% zoom)
remains open.
