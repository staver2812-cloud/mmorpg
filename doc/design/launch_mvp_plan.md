...
| `RESPONSIVE-001` | Adaptive UI across supported sizes and inputs | Done for recorded bounded checks; shell no longer forces 760px page min-width (390px path); ≤360px shell/Arena/paperdoll compression; short-landscape shell/Arena compression; Shop/Arena/shell/Inventory coarse-pointer 44px controls; Shop empty/licenses soften below 520px; location tabs wrap below 520px; expanded standard audit still open | Gameplay fidelity and adaptive UI matrix |
