...
- 2026-09-13: Shared landmark chrome exposes `data-landmark-inside`; Captured shop-shell desks also render landmark exit notes; smoke checks hospital and city Shop building for the marker.
...
- 2026-09-13: City Hall treasury exposes wallet/vault/VM data markers; quest board shows ready-to-turn-in count plus status counts (`data-city-hall-quest-active` / `available` / `locked` / `completed`).
