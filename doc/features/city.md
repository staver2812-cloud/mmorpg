...
- 2026-09-13: Watchtower directory posts live district offers from the current node; square overview board is localized (`data-guard-square`).
- 2026-09-13: Pitch Forge landmark showcase/repair cards are localized (`data-workshop-landmark`).
