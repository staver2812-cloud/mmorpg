...
- 2026-09-13: Veil Obelisk bind/recall (`POST .../obelisk`): stores coordinates in character metadata and recalls for 15 NV.
- 2026-09-13: Outdoor Obelisk recall chip plus Tavern table fatigue clear alongside HP/MP.
- 2026-09-13: Outdoor Obelisk recall chip greys out when wallet cannot cover the fare (`data-obelisk-chip-affordable`).
...
- 2026-09-13: Temple shows live injury status (Hospital link for heavy/combat); Dealer House shows junk buyback estimate; Inventory junk CTA mirrors count + estimated NV (`data-inventory-junk-total`); Ash Buyer desk shows live wallet NV (`data-junk-wallet`).
...
- 2026-09-13: Infirmary premium desk shows live Assault/Heal scroll bag totals matching HUD chips; greys out VM buys when short (`data-hospital-premium-affordable`); rest desk lists live injury summary (`data-hospital-injuries`).
